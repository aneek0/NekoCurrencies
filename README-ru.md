...
Бот автоматически определяет вашу операционную систему и применяет лучшие оптимизации производительности:

- **Unix/Linux/macOS**: Использует `uvloop` для 2-4x улучшения производительности
- **Windows**: Оптимизирован с `WindowsProactorEventLoopPolicy`
...
# Для Windows
# Встроенные оптимизации, дополнительные пакеты не требуются
```

См. [PERFORMANCE_OPTIMIZATION.ru.md](PERFORMANCE_OPTIMIZATION.ru.md) для подробной информации.
