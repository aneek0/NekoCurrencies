...
- **Новый источник API**: Добавлен НБРБ (Национальный банк Беларуси) API для официальных курсов BYN (запасной источник)
...
- **НБРБ**: API Национального банка Беларуси (официальные курсы)
...
3. **НБРБ API** (Национальный банк Беларуси)
   - Официальные курсы Беларуси
   - Бесплатный доступ
   - Запасной источник (может быть медленным)

4. **Запасные курсы** (Офлайн)
